...
import * as CZMJSON from '../../../build/contracts/CZMToken.json';
import { CZMToken } from '../../types/CZMToken';

const DEFAULT_SEND_OPTIONS = {
    gas: 6000000
};

export class CZMWrapper {
    web3: Web3;
    ...
    constructor(web3: Web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(CZMJSON.abi as any) as any;
    }
